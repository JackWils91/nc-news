...
Hosted: https://nc-news-jack-wilson.herokuapp.com/
...
```bash
git clone https://github.com/JackWils91/nc-news
```
...
Jack Wilson (JackWils91)

### Acknowledgements

Thank you to Northcoders who have been great throughout this whole process.
